...
export default function PharmacyLoginPage() {
  ...
  async function login(e: React.FormEvent) {
    ...
    else router.push("/pharmacy-portal");
  }
    ...
    <div className="max-w-md mx-auto mt-16">
      <div className="card p-8 space-y-6">
        <div className="text-center">
          ...
          <h1 className="text-xl font-bold text-gray-900">Pharmacy Partner Portal</h1>
          <p className="text-sm text-gray-500 mt-1">Sign in with your pharmacy staff account</p>
        </div>
